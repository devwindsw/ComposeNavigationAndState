...
import com.devwindsw.composenavigationandstate.base.SimpleUserInput
...
@Composable
fun SleepScreen(onPeopleChanged: (Int) -> Unit) {
    SearchScreen {
...
@Composable
fun EatScreen(onPeopleChanged: (Int) -> Unit) {
    SearchScreen {
        PeopleUserInput(onPeopleChanged = onPeopleChanged)
        Spacer(Modifier.height(8.dp))
        DatesUserInput()
...
@Composable
private fun SearchScreen(content: @Composable () -> Unit) {
